...
University of New Mexico, Albuquerque, New Mexico \hspace{0.2in} GPA 4.08 \hfill December 2016
...
RAVEN project \hfill    Fall 2014 - Present
 ...
 \begin{itemize} \itemsep -2pt
  \item Advanced collocation methods for uncertainty quantification
  \item High-dimension model reduction
  \item Sparse grid collocation
  \item Python, C++
\end{itemize} \vspace{-6pt}

{\sl TODO BYU-Idaho lab teaching, tutoring, Idaho Falls, ID} \\[2pt]
...
\vspace{15pt}
\begin{itemize}
  \item P. W. Talbot, ``Advanced Stochastic Collocatoin Methods for Polynomial Chaos in RAVEN,'', Ph. D.
