...
\begin{itemize} \itemsep -2pt
  \item \emph{Workpackage Manager and Area Lead, Integrated Energy Systems} \hfill 2020 - Present\\
  Managed Modeling and Simulation area and related workpackages within the U.S. Department of Energy
  crosscut program Integrated Energy Systems under National Technical Directors Dr. Shannon Bragg-Sitton followed
  by Dr. Richard Boardman. Coordinated labor and budgets across several NS\&T and EES\&T departments. Planned
  and executed work scopes for analysis of nuclear-renewable energy systems and economics in regional
  deployments as well as developing software to support technoeconomic analysis. Obtained software copyrights
  for HERON, TEAL, ORCA, and FORCE, and mentored software copyrights for NIHPA and DOVE.
  \item \emph{PI and lead developer, HERON (github.com/idaholab/HERON)} \hfill 2018 - Present \\
  Led a team of developers in implementing HERON, a Python-based object-oriented plugin of RAVEN
  ...
  \item \emph{LDRD awarded: Signal processing for cybersecurity} \hfill 2021-2023 \\
  ...
  \item \emph{Stochastic gradient descent optimization R\&D in RAVEN} \hfill 2017-2018
...
\vspace{8pt}
\center{
Expertise in Python (Conda, Pandas, Xarray, SKLearn, Statsmodels, OOP/Functional), Git, Bash\\
...
\vspace{15pt}
\begin{itemize}
  \item M. Basnet, J. Bryan, S. Dana, A. Meek, H. Wang, P. Talbot, ``Stochastic Optimization and Uncertainty Quantification of Natrium-based Nuclear-Renewable Energy Systems for Flexible Power Applications in Deregulated Markets'',
    Applied Energy 2024; vol 375, pp. 124105. \\https://doi.org/10.1016/j.apenergy.2024.124105
  \item G. Soto, B. Hanna, J. Toman, N. Guaita, P. Talbot, C. Lohse, A. Epiney, ``Powering Data Centers with Clean Energy: A Techno-Economic Case Study of Nuclear and Renewable Energy Dependability'',
    INL report INL/RPT-24-79307, 2024-08-06.
  \item B. Hanna, A. Abou-Jaoude, N. Guaita, P. Talbot, C. Lohse, ``Navigating Economies of Scale and Multiples for Nuclear-Powered Data Centers and Other Applications with High Service Availability Needs'',
    Energies 2024; vol. 17, pp. 5073. \\ https://doi.org/10.3390/en17205073
  ...
  %\item A. Epiney, C. Rabiti, P. Talbot, et al, "Case Study: Nuclear-Renewable-Water Integration in Arizona",
  %  INL report INL/EXT-18-51369, 2018
...
\begin{itemize}
  \item Reviewer: \emph{Applied Energy}, \emph{Energies}, \emph{Mathematics},
      \emph{Nuclear Science and Engineering}, \emph{Nuclear Technology}
