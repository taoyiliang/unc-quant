...
# Multidimensional version of meshgrid() essential for SparseGrid
# implementation.  Only appears in numpy 1.7 - this implementation taken from
# there, as most people have at most 1.6 installed.
