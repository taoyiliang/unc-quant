...
MC = 'MC_h1_zsimple5.samples'
HCs = ['HC_h1_zsimple5.moments']
TDs = ['TD_h1_zsimple5.moments']
#anis = ['HC_h5_1-1-2-2-4.moments']
#HCs = ['HC_h1_iso.moments',
#       'HC_h3_iso.moments',
#       'HC_h5_iso.moments']

ref=[0,2.24161549232357900318502015029321459064287926261577,
       19.6112025233016941880630788207704753175884641274388]
