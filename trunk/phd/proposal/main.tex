...
\textsc{\Large Doctoral Proposal}\\[0.5cm] % Thesis type
...
proposal we explore the behavior of traditional isotropic tensor product (TP) SCgPC, as well as
...
We analyze these methods on a series of models, including two analytic models and
...
We propose several improvements to the algorithms discussed.  First, we propose developing Sobol
decomposition, or the high-dimensional model representation (HDMR) method, wherein the uncertainty space is
treated as the superposition of constituent subspaces.  
Second, we propose developing adaptive algorithms for the intelligent
