...
\title[SC for Multigroup Neutron Diffusion] % (optional, use only with long paper titles)
...
\begin{frame}{test}{testaroo}
  \movie[showcontrols]{\includegraphics[width=0.2\textwidth]{core}}{one_shot.mpg}
\end{frame}
