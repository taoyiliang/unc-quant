...
\lhead{Chapter 6. \emph{Results: High-Density Model Reduction}} % Change X to a consecutive number; this is for the header on each page - perhaps a shortened title
